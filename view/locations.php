  ...
  <body>
    ...
    <section class="ftco-section goto-here">
		...
		if($page=="" || $page=="1"){
            ...
            $sql1 = "SELECT * FROM picz WHERE Locationn = '$loc' limit $page1,6";
            $result= mysqli_query($db,$sql1);
            while ($row = mysqli_fetch_array($result)){		
        echo "<div class='col-md-4 mt-4'>
        		<div class='property-wrap ftco-animate'>
				<a href='properties-single.php?id=".$row['ImagesID']."' class='img' id='img' style='background-image: url(PICS/".$row['ImageName'].");'>
        				<div class='rent-sale'>
		...
		*/
			echo "</section>";
		$sql1 = "SELECT * FROM picz WHERE Locationn = '$loc'";
