...
<html lang="en">
  <head>
    <title>Welcome to PropertyDash</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <section class="ftco-section goto-here">
		...
		if($page=="" || $page=="1"){
            ...
            $sql = "SELECT * FROM picz limit $page1,6";
            $result= mysqli_query($db,$sql);
            while ($row = mysqli_fetch_array($result)){		
        echo "<div class='col-md-4 mt-4'>
        		<div class='property-wrap ftco-animate'>
				<a href='' class='img' id='img' style='background-image: url(PICS/".$row['ImageName'].");'>
        				<div class='rent-sale'>
                    ...
                    <button class="btn btn-danger btn-sm delete"
                        ...
                        <span class='spinner-grow spinner-grow-sm'></span>Delete</button>
      ...
      <div id="id01" class="modal" style="width: 40%; margin: auto;">
        ...
        <div class="full text_align_center" style=" background-color: #90ee90; height: 150px;  ">
            ...
            <h5><b>Are you sure you want to remove this Property?</b></h5>
            <br><br>
              ...
              <a href="delete.php?id=<?php echo $row['ImagesID']; ?>" ><button style="width:50%; height: 40px; color: white; background-color: red;" >Delete</button></a>
        </div>
      </div>
            <?php
		}
		...
		*/
		...
		for($b = 1; $b <=$per_page; $b++){
            ...
            style='font-size: 30px;color: black;'href="../view/properties.php?page=<?php echo $b; ?>"> <?php echo "&laquo; ". $b." &raquo; ";?></a> <?php
        }
		echo "</div>";
